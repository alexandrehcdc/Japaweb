...
public class PageFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String url = servReq.getRequestURI();
        HttpSession session = servReq.getSession();
        
        if(servReq.getRequestURI() == ("/Login.xhtml")) {
            if(session.getAttribute("loggedUser") != null ) {
                HttpServletResponse servRes = (HttpServletResponse) response;
                servRes.sendRedirect(servReq.getContextPath() + "/Index.xhtml");
            } else {
            ...
            if(session.getAttribute("loggedUser") != null ) {
                ...
                HttpServletResponse servRes = (HttpServletResponse) response;
                servRes.sendRedirect(servReq.getContextPath() + "/Login.xhtml");
            }
        }
